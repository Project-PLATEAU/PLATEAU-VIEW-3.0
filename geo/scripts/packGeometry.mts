// ref: https://github.com/takram-design-engineering/plateau-view/blob/6c8225d626cd8085e5d10ffe8980837814c333b0/libs/nest-estat-areas/src/helpers/packGeometry.ts
...
function mapArrayObject<T, U>(array: ArrayObject<T>, iterator: (item: T) => U): U[] {
...
export function unpackGeometry(geometry: PackedGeometry): Polygon | MultiPolygon {
  if (geometry.type === "Polygon") {
    return {
      type: "Polygon",
