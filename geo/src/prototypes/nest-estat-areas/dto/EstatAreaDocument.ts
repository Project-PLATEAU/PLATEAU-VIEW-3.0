...
import { FirestoreCollection, validateSyncOrThrow } from "@prototypes/nest-firestore";
...
export class EstatAreaDocument {
  static fromFirestore(snapshot: QueryDocumentSnapshot<EstatAreaDocument>): EstatAreaDocument {
    return validateSyncOrThrow(plainToInstance(EstatAreaDocument, snapshot.data()));
  }
