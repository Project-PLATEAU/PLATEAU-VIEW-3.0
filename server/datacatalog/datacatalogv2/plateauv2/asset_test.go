...
func TestAssetNameFrom(t *testing.T) {
	...
	assert.Equal(t, AssetName{
		...
		LOD:      "1",
		Ext:      ".zip",
	}, AssetNameFrom("27221_kashiwara-shi_2022_3dtiles_0_bldg_lod1.zip"))
	...
	assert.Equal(t, AssetName{
		...
		LOD:      "1",
		Ext:      ".zip",
	}, AssetNameFrom("24212_kumano-shi_2022_3dtiles_2__0_bldg_lod1.zip"))
	...
	assert.Equal(t, AssetName{
		...
		Ext:      ".zip",
		FldAdmin: "pref",
		FldName:  "shakujiigawa-shirakogawa",
		FldScale: "l1",
	}, AssetNameFrom("13229_nishitokyo-shi_2022_3dtiles_1_op2_fld_pref_shakujiigawa-shirakogawa_l1.zip"))
	...
	assert.Equal(t, AssetName{
		...
		Op:        "4_op",
		Feature:   "ex",
		FeatureEx: []string{"port", "hogehoge", "hoge"},
		Ext:       ".zip",
		NoTexture: true,
	}, AssetNameFrom("01100_sapporo-shi_2020_3dtiles_4_op_ex-port-hogehoge-hoge_no_texture.zip"))
}
