...
import { DateControlGraph, type DateControlGraphProps } from "./DateControlGraph";
...
export interface DateControlSliderGraphProps extends Omit<DateControlGraphProps, "onChange"> {
