...
import { forwardRef, useCallback, useMemo, type ChangeEvent, type PropsWithoutRef } from "react";
...
}>(({ size = "small", indeterminate = false }) => {
  return {
    marginRight: 0,
    ...(indeterminate && {
...
export const SwitchParameterItem = forwardRef<HTMLDivElement, SwitchParameterItemProps>(
  ({ label, labelFontSize, description, atom: atomOrAtoms, onChange, ...props }, ref) => {
