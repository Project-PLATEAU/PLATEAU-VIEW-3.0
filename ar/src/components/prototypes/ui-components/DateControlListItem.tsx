import { ListItemButton, ListItemText, styled, type ListItemButtonProps } from "@mui/material";
...
export interface DateControlListItemProps extends Omit<ListItemButtonProps, "children"> {
  label: ReactNode;
  value?: ReactNode;
}

export const DateControlListItem = forwardRef<HTMLDivElement, DateControlListItemProps>(
