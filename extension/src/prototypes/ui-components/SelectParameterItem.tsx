...
export const SelectParameterItem = forwardRef<HTMLDivElement, SelectParameterItemProps>(
  (
    {
      label,
      labelFontSize,
    ...
    const handleChange = useCallback(
      (event: SelectChangeEvent<string | number | null>, child: ReactNode) => {
        setValue(hasNullValueItem && event.target.value === "" ? null : event.target.value);
