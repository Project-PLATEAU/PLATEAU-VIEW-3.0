...
export interface AppIconButtonProps extends ButtonProps, Pick<ShortcutTooltipProps, "shortcutKey"> {
  selected?: boolean;
  disableTooltip?: boolean;
}

export const AppIconButton = forwardRef<HTMLButtonElement, AppIconButtonProps>(
  ({ title, shortcutKey, selected = false, disableTooltip = false, ...props }, ref) => {
