...
const Item: FC<SelectItemProps & AppToggleButtonSelectItem> = ({ title, icon, ...props }) => (
...
export interface AppToggleButtonSelectProps extends Omit<AppToggleButtonProps, "children"> {
