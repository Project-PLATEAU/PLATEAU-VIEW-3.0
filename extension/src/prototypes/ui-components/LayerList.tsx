...
import { ForwardedRef, forwardRef, type MouseEventHandler, type ReactNode } from "react";
...
export const LayerList = forwardRef<HTMLDivElement, LayerListProps>(
  ({ listRef, footer, open = true, onOpen, onClose, children, ...props }, ref) => (
    <Root ref={ref} component="div" dense {...props}>
      ...
      <Footer aria-label={open ? "閉じる" : "開く"} onClick={open ? onClose : onOpen}>
