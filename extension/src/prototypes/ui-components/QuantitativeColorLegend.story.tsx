...
import { colorMapCividis, colorMapTurbo, colorMapViridis } from "../color-maps";
...
const Component: FC = () => {
  ...
  return (
    <Stack spacing={2}>
      ...
      <QuantitativeColorLegend min={min1} max={max1} colorMap={colorMapViridis} />
      <SliderParameterItem min={0} max={100} range atom={rangeAtom2} />
      <QuantitativeColorLegend min={min2} max={max2} colorMap={colorMapCividis} />
