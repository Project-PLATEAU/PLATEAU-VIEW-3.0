...
export type NumberParameterItemProps = PropsWithoutRef<Omit<TextFieldProps, "value">> &
...
export const NumberParameterItem = forwardRef<HTMLDivElement, NumberParameterItemProps>(
  ({ label, labelFontSize, description, unit, atom: atomOrAtoms, onChange, ...props }, ref) => {
